...
public class CommandTestUtil {
    ...
    public static final String INVALID_ADDRESS_DESC = " " + PREFIX_HOME_ADDRESS;
    ...
    static {
        DESC_AMY = new EditPersonDescriptorBuilder().withName(VALID_NAME_AMY)
                .withPhone(VALID_PHONE_AMY).withEmail(VALID_EMAIL_AMY).withHomeAddress(VALID_HOME_ADDRESS_AMY)
                .withTags(VALID_TAG_FRIEND).build();
        DESC_BOB = new EditPersonDescriptorBuilder().withName(VALID_NAME_BOB)
                .withPhone(VALID_PHONE_BOB).withEmail(VALID_EMAIL_BOB).withHomeAddress(VALID_HOME_ADDRESS_BOB)
